    ...
    - JSP内置对象：JSP内置对象是Web容器创建的一组对象，不使用new关键字就可以使用的内置对象
        ...
        4. Session对象
            ...
            - Session的生命周期
                ...
                - Tips：原有的会话还存在，只是这个旧的Session仍然存在与服务器，只不过再也没有客户端会携带它然后交予服务端校验
        ...
        2. 保存用户状态的两大机制
            ...
            2. session与cookie的异同
                - 相同点
                    ...
                    2. 都会过期，都有生存期限
                - 不同点
                    1. session保存在**服务器**，cookie以文本形式保存在**客户端**
